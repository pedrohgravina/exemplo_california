...
# Usada para manipular caminho de arquivos


PASTA_PROJETO = Path(__file__).resolve().parents[2]
# Aqui tá colocando dentro da variável PASTA_PROJETO o caminho da pasta projeto

PASTA_DADOS = PASTA_PROJETO / "dados"
# Aqui tá colocando dentro da variável PASTA_DADOS todo o caminho da PASTA_PROJETO e criando uma nova pasta, chamada "dados"
