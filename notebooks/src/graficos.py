...
PALETTE = "coolwarm"
SCATTER_ALPHA = 0.2 # Transparência das bolinhas dos gráficos de dispersão
...
def plot_residuos_estimador(estimator, X, y, eng_formatter=False, fracao_amostra=0.25):
    # "eng_formatter" muda o formato dos números pra que eles fiquem mais arrumadinhos
    # facilitanto a leitura

    # "fracao_amostra" é percentual dos dados que serão calculados
